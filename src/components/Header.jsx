...
const Header = () => (
  <header className="flex items-center justify-center flex-col">
    <h1 className={`text-5xl font-bold ${styles.paddingY} tracking-wider`}>Abozaid</h1>
    <Title />
    ...
    <div className="relative">
      ...
      <div className="absolute -z-10 inset-0 rounded-[10px] w-full h-full blue-pink-gradient blur-lg"></div>
    </div>
  </header>
);

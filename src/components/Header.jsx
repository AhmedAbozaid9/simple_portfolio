...
const Header = () => (
  <header className="flex items-center justify-center flex-col py-16 ">
    <h1 className="text-4xl sm:text-5xl font-bold pb-16 tracking-wider dark:text-white">Abozaid</h1>
    <Title />
    ...
    <div className="relative">
      ...
      <div className="absolute -z-10 inset-0 rounded-[10px] w-full h-full blue-pink-gradient blur-[7px]"></div>
    </div>
  </header>
);
